...
const getCiphertext = async (handle: any, ethers: typeof hethers): Promise<string> => {
 ...
 * @returns {bigint}
 */
export const decrypt4 = async (handle: any): Promise<bigint> => {
  if (network.name === 'hardhat') {
    await awaitCoprocessor();
 ...
 * @returns {bigint}
 */
export const decrypt8 = async (handle: any): Promise<bigint> => {
  if (network.name === 'hardhat') {
    await awaitCoprocessor();
    return BigInt(await getClearText(handle));
  } else {
 ...
 * @returns {bigint}
 */
export const decrypt16 = async (handle: any): Promise<bigint> => {
  if (network.name === 'hardhat') {
    await awaitCoprocessor();
    return BigInt(await getClearText(handle));
  } else {
 ...
 * @returns {bigint}
 */
export const decrypt32 = async (handle: any): Promise<bigint> => {
  if (network.name === 'hardhat') {
    await awaitCoprocessor();
    return BigInt(await getClearText(handle));
  } else {
 ...
 * @returns {bigint}
 */
export const decrypt64 = async (handle: any): Promise<bigint> => {
  if (network.name === 'hardhat') {
    await awaitCoprocessor();
    return BigInt(await getClearText(handle));
  } else {
 ...
 * @returns {bigint}
 */
export const decrypt128 = async (handle: any): Promise<bigint> => {
  if (network.name === 'hardhat') {
    await awaitCoprocessor();
    return BigInt(await getClearText(handle));
  } else {
 ...
 * @returns {bigint}
 */
export const decrypt256 = async (handle: any): Promise<bigint> => {
  if (network.name === 'hardhat') {
    await awaitCoprocessor();
    return BigInt(await getClearText(handle));
  } else {
 ...
 * @returns {string}
 */
export const decryptAddress = async (handle: any): Promise<string> => {
  if (network.name === 'hardhat') {
    await awaitCoprocessor();
 ...
 * @returns {bigint}
 */
export const decryptEbytes64 = async (handle: any): Promise<bigint> => {
  if (network.name === 'hardhat') {
    await awaitCoprocessor();
    return BigInt(await getClearText(handle));
  } else {
 ...
 * @returns {bigint}
 */
export const decryptEbytes128 = async (handle: any): Promise<bigint> => {
  if (network.name === 'hardhat') {
    await awaitCoprocessor();
    return BigInt(await getClearText(handle));
  } else {
 ...
 * @returns {bigint}
 */
export const decryptEbytes256 = async (handle: any): Promise<bigint> => {
  if (network.name === 'hardhat') {
    await awaitCoprocessor();
    return BigInt(await getClearText(handle));
  } else {
